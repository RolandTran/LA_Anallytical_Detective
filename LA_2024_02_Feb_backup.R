...
top_3_Vict.Descent <- names(top_3_Sorted_Vict.Descent)
top_3_Vict.Descent
top_3_labels_Vict.Descent <- vict_descent_legend[top_3_Vict.Descent]
top_3_labels_Vict.Descent
top_3_counts_Vict.Descent <- as.numeric(top_3_Sorted_Vict.Descent)
top_3_counts_Vict.Descent

# Print summary with full legend names
cat(paste0(
  top_3_labels_Vict.Descent[1], " had the most Vict.Descent incidents with ", top_3_counts_Vict.Descent[1], " cases; ",
  top_3_labels_Vict.Descent[2], " followed with ", top_3_counts_Vict.Descent[2], " cases; and ",
  top_3_labels_Vict.Descent[3], " had ", top_3_counts_Vict.Descent[3], " cases."
))
